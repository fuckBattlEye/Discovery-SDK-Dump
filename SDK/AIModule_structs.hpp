...
struct FEnvTraceData
{
	...
	struct FName                                       TraceProfileName;                                         // 0x002C(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<EEnvTraceShape>                        TraceShape;                                               // 0x0034(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<EEnvQueryTrace>                        TraceMode;                                                // 0x0035(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0036(0x0002) MISSED OFFSET
	unsigned char                                      bTraceComplex : 1;                                        // 0x0038(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bOnlyBlockingHits : 1;                                    // 0x0038(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bCanTraceOnNavMesh : 1;                                   // 0x0038(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bCanTraceOnGeometry : 1;                                  // 0x0038(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bCanDisableTrace : 1;                                     // 0x0038(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bCanProjectDown : 1;                                      // 0x0038(0x0001) (Edit, DisableEditOnInstance)
...
{
	class UClass*                                      PropertyType;                                             // 0x0020(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
...
struct FAIDamageEvent
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FVector                                     Location;                                                 // 0x0008(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     HitLocation;                                              // 0x0020(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class AActor*                                      DamagedActor;                                             // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class AActor*                                      Instigator;                                               // 0x0040(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAINoiseEvent
{
	...
	struct FVector                                     NoiseLocation;                                            // 0x0008(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Loudness;                                                 // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxRange;                                                 // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class AActor*                                      Instigator;                                               // 0x0028(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       Tag;                                                      // 0x0030(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAITeamStimulusEvent
{
	...
	class AActor*                                      Broadcaster;                                              // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData)
	class AActor*                                      Enemy;                                                    // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FAITouchEvent
{
	...
	class AActor*                                      TouchReceiver;                                            // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
	class AActor*                                      OtherActor;                                               // 0x0020(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FEnvOverlapData
{
	...
	struct FVector                                     ShapeOffset;                                              // 0x0010(0x0018) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     OverlapChannel;                                           // 0x0028(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<EEnvOverlapShape>                      OverlapShape;                                             // 0x0029(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x002A(0x0002) MISSED OFFSET
	unsigned char                                      bOnlyBlockingHits : 1;                                    // 0x002C(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bOverlapComplex : 1;                                      // 0x002C(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bSkipOverlapQuerier : 1;                                  // 0x002C(0x0001) (Edit, DisableEditOnInstance)
...
struct FAIStimulus
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FVector                                     StimulusLocation;                                         // 0x0010(0x0018) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     ReceiverLocation;                                         // 0x0028(0x0018) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       Tag;                                                      // 0x0040(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0048(0x000C) MISSED OFFSET
	unsigned char                                      UnknownData02 : 1;                                        // 0x0054(0x0001)
	unsigned char                                      bSuccessfullySensed : 1;                                  // 0x0054(0x0001) (BlueprintVisible)
...
{
	int                                                TargetId;                                                 // 0x0000(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class AActor>                       Target;                                                   // 0x0004(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FAIStimulus                                 Stimulus;                                                 // 0x0010(0x0058) (BlueprintVisible)
};
...
{
	float                                              MaxAllowedTestingTime;                                    // 0x0000(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bTestQueriesUsingBreadth;                                 // 0x0004(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0005(0x0003) MISSED OFFSET
	int                                                QueryCountWarningThreshold;                               // 0x0008(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	double                                             QueryCountWarningInterval;                                // 0x0010(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	double                                             ExecutionTimeWarningSeconds;                              // 0x0018(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	double                                             HandlingResultTimeWarningSeconds;                         // 0x0020(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	double                                             GenerationTimeWarningSeconds;                             // 0x0028(0x0008) (ZeroConstructor, Config, IsPlainOldData)
};
...
{
	class ARecastNavMesh*                              RecastNavMeshActor;                                       // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
