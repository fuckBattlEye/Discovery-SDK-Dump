...
// BlueprintGeneratedClass BP_LightBody_HitscanValidation_Crouching.BP_LightBody_HitscanValidation_Crouching_C
// 0x0020 (0x02E8 - 0x02C8)
class ABP_LightBody_HitscanValidation_Crouching_C : public AActor
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr)
			ptr = UObject::FindClass(XorStr("BlueprintGeneratedClass BP_LightBody_HitscanValidation_Crouching.BP_LightBody_HitscanValidation_Crouching_C"));
		return ptr;
	}
