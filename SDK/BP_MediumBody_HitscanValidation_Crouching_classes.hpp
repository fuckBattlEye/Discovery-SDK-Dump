...
// BlueprintGeneratedClass BP_MediumBody_HitscanValidation_Crouching.BP_MediumBody_HitscanValidation_Crouching_C
// 0x0020 (0x02E8 - 0x02C8)
class ABP_MediumBody_HitscanValidation_Crouching_C : public AActor
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr)
			ptr = UObject::FindClass(XorStr("BlueprintGeneratedClass BP_MediumBody_HitscanValidation_Crouching.BP_MediumBody_HitscanValidation_Crouching_C"));
		return ptr;
	}
