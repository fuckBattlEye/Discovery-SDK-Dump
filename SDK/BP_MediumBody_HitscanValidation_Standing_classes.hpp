...
// BlueprintGeneratedClass BP_MediumBody_HitscanValidation_Standing.BP_MediumBody_HitscanValidation_Standing_C
// 0x0020 (0x02E8 - 0x02C8)
class ABP_MediumBody_HitscanValidation_Standing_C : public AActor
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr)
			ptr = UObject::FindClass(XorStr("BlueprintGeneratedClass BP_MediumBody_HitscanValidation_Standing.BP_MediumBody_HitscanValidation_Standing_C"));
		return ptr;
	}
