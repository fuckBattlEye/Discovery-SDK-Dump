...
struct FAssetBundleEntry
{
	...
	TArray<struct FSoftObjectPath>                     BundleAssets;                                             // 0x0008(0x0010) (ZeroConstructor)
};
...
struct FBox
{
	struct FVector                                     Min;                                                      // 0x0000(0x0018) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector                                     Max;                                                      // 0x0018(0x0018) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
...
struct FBox2D
{
	struct FVector2D                                   Min;                                                      // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector2D                                   Max;                                                      // 0x0010(0x0010) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      bIsValid;                                                 // 0x0020(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FVector2f
{
	float                                              X;                                                        // 0x0000(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              Y;                                                        // 0x0004(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FBox2f
{
	struct FVector2f                                   Min;                                                      // 0x0000(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector2f                                   Max;                                                      // 0x0008(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
...
struct FVector3d
{
	double                                             X;                                                        // 0x0000(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	double                                             Y;                                                        // 0x0008(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	double                                             Z;                                                        // 0x0010(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FBox3d
{
	struct FVector3d                                   Min;                                                      // 0x0000(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector3d                                   Max;                                                      // 0x0018(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      IsValid;                                                  // 0x0030(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0031(0x0007) MISSED OFFSET
};
...
struct FVector3f
{
	float                                              X;                                                        // 0x0000(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              Y;                                                        // 0x0004(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              Z;                                                        // 0x0008(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FBox3f
{
	struct FVector3f                                   Min;                                                      // 0x0000(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector3f                                   Max;                                                      // 0x000C(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
...
{
	struct FVector                                     Origin;                                                   // 0x0000(0x0018) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector                                     BoxExtent;                                                // 0x0018(0x0018) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
...
{
	struct FVector3d                                   Origin;                                                   // 0x0000(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector3d                                   BoxExtent;                                                // 0x0018(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	double                                             SphereRadius;                                             // 0x0030(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
{
	struct FVector3f                                   Origin;                                                   // 0x0000(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector3f                                   BoxExtent;                                                // 0x000C(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              SphereRadius;                                             // 0x0018(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FInterpCurvePointQuat
{
	...
	struct FQuat                                       OutVal;                                                   // 0x0010(0x0020) (Edit, BlueprintVisible, IsPlainOldData)
	struct FQuat                                       ArriveTangent;                                            // 0x0030(0x0020) (Edit, BlueprintVisible, IsPlainOldData)
	struct FQuat                                       LeaveTangent;                                             // 0x0050(0x0020) (Edit, BlueprintVisible, IsPlainOldData)
	TEnumAsByte<EInterpCurveMode>                      InterpMode;                                               // 0x0070(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FTwoVectors
{
	struct FVector                                     v1;                                                       // 0x0000(0x0018) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector                                     v2;                                                       // 0x0018(0x0018) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FInterpCurvePointTwoVectors
{
	...
	struct FTwoVectors                                 OutVal;                                                   // 0x0008(0x0030) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FTwoVectors                                 ArriveTangent;                                            // 0x0038(0x0030) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FTwoVectors                                 LeaveTangent;                                             // 0x0068(0x0030) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EInterpCurveMode>                      InterpMode;                                               // 0x0098(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FInterpCurvePointVector
{
	float                                              InVal;                                                    // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FVector                                     OutVal;                                                   // 0x0008(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<EInterpCurveMode>                      InterpMode;                                               // 0x0050(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FInterpCurvePointVector2D
{
	float                                              InVal;                                                    // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FVector2D                                   OutVal;                                                   // 0x0008(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ArriveTangent;                                            // 0x0018(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   LeaveTangent;                                             // 0x0028(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EInterpCurveMode>                      InterpMode;                                               // 0x0038(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FMatrix
{
	struct FPlane                                      XPlane;                                                   // 0x0000(0x0020) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane                                      YPlane;                                                   // 0x0020(0x0020) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane                                      ZPlane;                                                   // 0x0040(0x0020) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane                                      WPlane;                                                   // 0x0060(0x0020) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
{
	double                                             W;                                                        // 0x0018(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FMatrix44d
{
	struct FPlane4d                                    XPlane;                                                   // 0x0000(0x0020) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane4d                                    YPlane;                                                   // 0x0020(0x0020) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane4d                                    ZPlane;                                                   // 0x0040(0x0020) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane4d                                    WPlane;                                                   // 0x0060(0x0020) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
{
	float                                              W;                                                        // 0x000C(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FMatrix44f
{
	struct FPlane4f                                    XPlane;                                                   // 0x0000(0x0010) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane4f                                    YPlane;                                                   // 0x0010(0x0010) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane4f                                    ZPlane;                                                   // 0x0020(0x0010) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FPlane4f                                    WPlane;                                                   // 0x0030(0x0010) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FOrientedBox
{
	struct FVector                                     Center;                                                   // 0x0000(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector                                     AxisX;                                                    // 0x0018(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector                                     AxisY;                                                    // 0x0030(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector                                     AxisZ;                                                    // 0x0048(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	double                                             ExtentX;                                                  // 0x0060(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	double                                             ExtentY;                                                  // 0x0068(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	double                                             ExtentZ;                                                  // 0x0070(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FPolyglotTextData
{
	...
	TMap<struct FString, struct FString>               LocalizedStrings;                                         // 0x0048(0x0050) (Edit, BlueprintVisible)
...
struct FRotator3d
{
	double                                             Pitch;                                                    // 0x0000(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	double                                             Yaw;                                                      // 0x0008(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	double                                             Roll;                                                     // 0x0010(0x0008) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
struct FRotator3f
{
	float                                              Pitch;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              Yaw;                                                      // 0x0004(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              Roll;                                                     // 0x0008(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
{
	class UObject*                                     UninitializedObjectReference;                             // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UObject*                                     InitializedObjectReference;                               // 0x0008(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              UnusedValue;                                              // 0x0010(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
	struct FQuat                                       Rotation;                                                 // 0x0000(0x0020) (Edit, BlueprintVisible, SaveGame, IsPlainOldData)
	struct FVector                                     Translation;                                              // 0x0020(0x0018) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0038(0x0008) MISSED OFFSET
	struct FVector                                     Scale3D;                                                  // 0x0040(0x0018) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
...
struct FTransform3d
{
	struct FQuat4d                                     Rotation;                                                 // 0x0000(0x0020) (Edit, SaveGame, IsPlainOldData)
	struct FVector3d                                   Translation;                                              // 0x0020(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0038(0x0008) MISSED OFFSET
	struct FVector3d                                   Scale3D;                                                  // 0x0040(0x0018) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0058(0x0008) MISSED OFFSET
};
...
struct FTransform3f
{
	struct FQuat4f                                     Rotation;                                                 // 0x0000(0x0010) (Edit, SaveGame, IsPlainOldData)
	struct FVector3f                                   Translation;                                              // 0x0010(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	struct FVector3f                                   Scale3D;                                                  // 0x0020(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
