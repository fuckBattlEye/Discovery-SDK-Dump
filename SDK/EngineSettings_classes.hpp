...
public:
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class EngineSettings.ConsoleSettings"));
		return ptr;
	}
...
public:
	...
	enum class EFourPlayerSplitScreenType              FourPlayerSplitscreenLayout;                              // 0x0053(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class EngineSettings.GameMapsSettings"));
		return ptr;
	}


	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer);//Offset:Discovery.exe+0x4006940
	bool GetSkipAssigningGamepadToPlayer1();//Offset:Discovery.exe+0x4006910
	class UGameMapsSettings* STATIC_GetGameMapsSettings();//Offset:Discovery.exe+0x40069E0
};
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class EngineSettings.GameNetworkManagerSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class EngineSettings.GameSessionSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class EngineSettings.GeneralEngineSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class EngineSettings.GeneralProjectSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class EngineSettings.HudSettings"));
		return ptr;
	}
