...
public:
	...
	struct FString                                     OSSName;                                                  // 0x01F8(0x0010) (ZeroConstructor, Config)
	struct FString                                     HotfixManagerClassName;                                   // 0x0208(0x0010) (ZeroConstructor, Config)
	struct FString                                     DebugPrefix;                                              // 0x0218(0x0010) (ZeroConstructor, Config)
	TArray<class UObject*>                             AssetsHotfixedFromIniFiles;                               // 0x0228(0x0010) (ZeroConstructor, Transient)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class Hotfix.OnlineHotfixManager"));
		return ptr;
	}


	void StartHotfixProcess();//Offset:Discovery.exe+0x2021540
};
...
public:
	...
	enum class EUpdateState                            CurrentUpdateState;                                       // 0x00AB(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	enum class EHotfixResult                           LastHotfixResult;                                         // 0x00B4(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	enum class EUpdateCompletionStatus                 LastCompletionResult[0x2];                                // 0x00E8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x26];                                      // 0x00EA(0x0026) MISSED OFFSET
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if(!ptr)
			ptr = UObject::FindClass(XorStr("Class Hotfix.UpdateManager"));
		return ptr;
	}
