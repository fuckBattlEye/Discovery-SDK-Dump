...
void UTurnBasedMatchInterface::OnMatchReceivedTurn(const struct FString& Match, bool bDidBecomeActive)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>(XorStr("Function OnlineSubsystem.TurnBasedMatchInterface.OnMatchReceivedTurn"));
...
void UTurnBasedMatchInterface::OnMatchEnded(const struct FString& Match)
{
	static UFunction* fn = nullptr;
	if(!fn)
		fn = UObject::FindObject<UFunction>(XorStr("Function OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded"));
