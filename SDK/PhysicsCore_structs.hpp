...
struct FBodyInstanceCore
{
	...
	unsigned char                                      bGenerateWakeEvents : 1;                                  // 0x0010(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bUpdateMassWhenScaleChanges : 1;                          // 0x0010(0x0001) (Edit, BlueprintVisible)
