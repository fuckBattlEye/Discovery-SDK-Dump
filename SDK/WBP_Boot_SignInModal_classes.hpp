...
// WidgetBlueprintGeneratedClass WBP_Boot_SignInModal.WBP_Boot_SignInModal_C
// 0x0020 (0x03F0 - 0x03D0)
class UWBP_Boot_SignInModal_C : public USignInModalWidget
{
public:
	...
	class UWBP_FrontendNotificationTemplate_C*         Template;                                                 // 0x03E0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr)
			ptr = UObject::FindClass(XorStr("WidgetBlueprintGeneratedClass WBP_Boot_SignInModal.WBP_Boot_SignInModal_C"));
		return ptr;
	}
